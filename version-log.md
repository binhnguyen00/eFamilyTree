# Version 1.6.5
### [Version Demo](https://zalo.me/s/3044106383419412609/?env=TESTING&version=78)
### Thay đổi
#### 1. Thư viện Ảnh
...
#### Tích hợp Trợ Lý Gia Phả
  - Trợ lý giúp trả lời các thắc mắc liên quan đến phần mềm.
  - Trợ lý chưa được cá nhân hoá cho từng người và từng dòng họ.
...
#### 1. Bảng Vàng (Hall of Fame) giờ đã có thể CRUD dữ liệu.
  ...
  - Xoá thành viên được chọn khỏi bảng vàng.
  - Xem thông tin chi tiết của một thành viên trong bảng vàng (bao gồm cả avatar).
